...
function Profiles() {
    ...
    <img src="https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" />
      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        <div className="grid grid-cols-2 gap-x-4">
          <div>
            <div className="block mb-2 text-sm font-bold text-gray-600">Họ và tên</div>
  ...
  <input type="text" className="grow" />
          ...
          <div>
            <div className="block mb-2 text-sm font-bold text-gray-600">Số điện thoại</div>
              <label className="input input-bordered flex items-center gap-2">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  <input type="text" className="grow" />
        ...
        <div className="grid grid-cols-2 gap-x-4 mt-4">
          <div>
            <div className="block mb-2 text-sm font-bold text-gray-600">Email</div>
            <label className="input input-bordered flex items-center gap-2">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  <input type="text" className="grow"  />
          ...
          <div>
            <div className="block mb-2 text-sm font-bold text-gray-600">Địa chỉ</div>
            <label className="input input-bordered flex items-center gap-2">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
